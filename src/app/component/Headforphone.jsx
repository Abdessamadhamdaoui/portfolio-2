...
export default function Headforphone() {
  return (
    <div className=' relative '>
      <div style={{ backgroundColor: 'rgb(245, 101, 57)' }} className='h-[320px] w-full'>
      <h1 style={{fontFamily: 'Pacifico, cursive'  }} className="text-black p-9 font-serif text-2xl">hamdaoui</h1>
      <div style={{ backgroundImage: "url('https://cdn.discordapp.com/attachments/796024617835036693/1122166009130926080/IMG-20220705-WA0033.jpg')", 
      backgroundSize: 'cover',
       borderRadius: '50%', position: 'absolute', top: '200px', left: '25%', width: '280px', height: 
       '280px',borderColor:'rgb(33, 33, 33)' }} className=' border-8' ></div>
